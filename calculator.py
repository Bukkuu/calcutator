...
button_0=Button(root,text="0",padx=40,pady=20,command=lambda:button_click(0))
button_add=Button(root,text="+",padx=39,pady=20,command=button_add)
button_sub=Button(root,text="-",padx=49,pady=20,command=button_sub)
button_mult=Button(root,text="*",padx=49,pady=20,command=button_mult)
button_div=Button(root,text="/",padx=49,pady=20,command=button_div)
button_equal=Button(root,text="=",padx=49,pady=20,command=button_equal)
